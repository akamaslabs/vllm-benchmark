#!/bin/bash
# Load-test step for 10-gpt-oss-20b-goodput-per-gpu (runs on the toolbox host via the
...
set -e
BENCH_FILE=/work/vllm-benchmark/studies/10-gpt-oss-20b-goodput-per-gpu/k8s/05-job.yaml
