#!/bin/bash
# Load-test step for 11-gpt-oss-20b-tps-peak (runs on the toolbox host via the
...
set -e
BENCH_FILE=/work/vllm-benchmark/studies/11-gpt-oss-20b-tps-peak/k8s/05-job.yaml
