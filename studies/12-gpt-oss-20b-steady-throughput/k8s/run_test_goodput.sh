#!/bin/bash
# Load-test step for 12-gpt-oss-20b-steady-throughput (runs on the toolbox host via the
...
set -e
BENCH_FILE=/work/vllm-benchmark/studies/12-gpt-oss-20b-steady-throughput/k8s/05-job.yaml
