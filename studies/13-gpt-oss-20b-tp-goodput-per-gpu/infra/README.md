...
> Copied from `9-goodput-per-gpu/infra/` on 2026-09-14 (via `12-gpt-oss-20b-steady-throughput`, 2026-09-15) for `13-gpt-oss-20b-tp-goodput-per-gpu`
...
```bash
cd studies/13-gpt-oss-20b-tp-goodput-per-gpu/infra/eks
