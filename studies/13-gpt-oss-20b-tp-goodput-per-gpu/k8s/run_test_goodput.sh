#!/bin/bash
# Load-test step for 13-gpt-oss-20b-tp-goodput-per-gpu (runs on the toolbox host via the
...
set -e
BENCH_FILE=/work/vllm-benchmark/studies/13-gpt-oss-20b-tp-goodput-per-gpu/k8s/05-job.yaml
