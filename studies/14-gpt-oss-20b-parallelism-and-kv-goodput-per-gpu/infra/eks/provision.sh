...
# Provision the vllm-bench EKS cluster for this study (13-gpt-oss-20b-tp-goodput-per-gpu).
#
...
echo ""
echo "=== vllm-bench EKS Cluster (studies/13-gpt-oss-20b-tp-goodput-per-gpu) ==="
...
echo ""
echo "  2. Confirm the vllm-model-cache-gptoss PVC lands in the same AZ as wherever"
