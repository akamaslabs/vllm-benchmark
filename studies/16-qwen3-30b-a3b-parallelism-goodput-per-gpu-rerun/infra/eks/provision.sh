...
# Provision the vllm-bench EKS cluster for this study (15-qwen3-30b-a3b-parallelism-goodput-per-gpu).
#
...
echo ""
echo "=== vllm-bench EKS Cluster (studies/15-qwen3-30b-a3b-parallelism-goodput-per-gpu) ==="
...
echo ""
echo "  2. Confirm the vllm-model-cache-qwen3moe PVC lands in the same AZ as wherever"
