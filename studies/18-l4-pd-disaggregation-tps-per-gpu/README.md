...
- **System** `vLLM_Benchmark_18_L4_PD_Disaggregation`, 11 components:
...
- **Telemetry instance** `Prometheus_18_L4_PD_Disaggregation`, `akamas/telemetry/prometheus.yaml`.
...
- **Workflow** `18-L4-PD-Disaggregation-Workflow`, 3 tasks on the `toolbox` host with key
...
`cd /work/vllm-benchmark/studies/18-l4-pd-disaggregation-tps-per-gpu/akamas`.

Typed form, in dependency order:
```bash
akamas create system system.yaml
akamas create component components/pd_topology.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create component components/vllm_prefill.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create component components/vllm_decode.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create component components/gpu0.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create component components/gpu1.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create component components/gpu2.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create component components/gpu3.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create component components/cluster.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create component components/cluster_loadtest.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create component components/container.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create component components/container_loadtest.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create telemetry-instance telemetry/prometheus.yaml vLLM_Benchmark_18_L4_PD_Disaggregation
akamas create workflow 18-L4-PD-Disaggregation-Workflow.yaml
akamas create study 18-L4-PD-Disaggregation-TPS-Per-GPU.yaml

akamas start study "18-L4-PD-Disaggregation-TPS-Per-GPU"
```
...
akamas create -f 18-L4-PD-Disaggregation-Workflow.yaml
akamas create -f 18-L4-PD-Disaggregation-TPS-Per-GPU.yaml
```

After the run, export it straight away, because Prometheus keeps only 10 days:
`akamas export study "18-L4-PD-Disaggregation-TPS-Per-GPU" studies/18-l4-pd-disaggregation-tps-per-gpu/results/export.tar.gz`.

Editing a created study: on 3.7.x only the goal can be updated in place
(`akamas update study "18-L4-PD-Disaggregation-TPS-Per-GPU" 18-L4-PD-Disaggregation-TPS-Per-GPU.yaml`).
